...
namespace OpenSource.UPnP
{
    ...
    public sealed class UPnPSmartControlPoint
    {
        ...
        /// <summary>
        /// Triggered when the initial NetworkSearch is complete
        /// </summary>
        ...
        public UPnPSmartControlPoint(DeviceHandler OnAddedDeviceSink, ServiceHandler OnAddedServiceSink, string[] Filters)
        {
            ...
            //iSCP.OnSearchComplete += new UPnPInternalSmartControlPoint.DeviceHandler(HandleSearchComplete);
            iSCP.MySearchComplete += OnSearchComplete;
        ...
        private void HandleSearchComplete(UPnPInternalSmartControlPoint sender, UPnPDevice device)
        {
