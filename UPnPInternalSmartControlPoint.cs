...
namespace OpenSource.UPnP
{
    ...
    internal sealed class UPnPInternalSmartControlPoint
    {
        ...
        private WeakEvent OnSearchCompleteEvent = new WeakEvent();
        public event EventHandler MySearchComplete;
        ...
        public event DeviceHandler OnSearchComplete
        {
            add { OnSearchCompleteEvent.Register(value); }
            remove { OnSearchCompleteEvent.UnRegister(value); }
        }
        ...
        public UPnPInternalSmartControlPoint()
        {
            ...
            genericControlPoint.OnSearchComplete += MySearchComplete;
